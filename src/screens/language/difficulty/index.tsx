...
async function getDifficulty() {
    const languageQuerySnapshot = await firestore().collection('language').orderBy("order").get();
...
<View className='bg-custom-language flex flex-1 p-3 '>

        {
            ...
            <Text className='text-1xl font-medium'> Select a difficulty  to start playing</Text>
