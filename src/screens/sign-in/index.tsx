import { View, Text, StyleSheet, ScrollView, Image, Pressable, KeyboardAvoidingView } from 'react-native'
...
const SignIn = () => {
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <KeyboardAvoidingView className='flex-1 items-center justify-start  bg-blue-200'>
          ...
          >
            {({ handleChange, handleBlur, handleSubmit, values }) => (
              <View>
                ...
                <Button radius={'md'} title="Sign In" titleStyle={
                  {
